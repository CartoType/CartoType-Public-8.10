...
public class MainActivity extends AppCompatActivity implements LocationListener
    ...
    boolean hasRoute()
        {
        return m_framework != null && m_framework.routeCount() != 0;
        }
    ...
    void createScaleBarAndTurnInstructions()
        ...
        if (width_in_inches > 3.0)
            width_in_inches = 3.0;
        m_framework.setScaleBar(width_in_inches,"in",NoticePosition.BottomLeft);
        m_framework.setTurnInstructions(false, width_in_inches, "in", NoticePosition.TopLeft, 14, "pt");
        }
